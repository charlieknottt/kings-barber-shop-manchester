        ...
        <div className="flex justify-between items-center h-16 sm:h-20">
          <a href="#" className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="font-serif text-xl sm:text-2xl font-bold text-cream">
              KING&apos;S<span className="text-forest">.</span>
            </span>
          </a>
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        <h1 className="font-serif text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-bold text-cream mb-4 sm:mb-6 animate-fade-in leading-tight">
          KING&apos;S
          <br />
          <span className="text-gradient">BARBER SHOP</span>
        </h1>
        <p className="text-cream/60 font-sans text-base sm:text-lg md:text-xl max-w-xl mx-auto mb-8 sm:mb-10 animate-fade-in-up px-4">
          A cut above. Traditional techniques with modern styles. Drinks, sports, and a great cut.
        </p>
...
function ServicesSection() {
  const services = [
    {
      name: "Traditional Barber Haircut",
      description: "Classic barbershop haircut with precision and care",
      price: "$34",
      duration: "30 min",
    },
    {
      name: "Traditional Shave",
      description: "Hot towel straight razor shave for a clean finish",
      price: "$34",
      duration: "40 min",
    },
    {
      name: "Mustache & Beard Trim",
      description: "Professional beard and mustache shaping",
      price: "$16",
      duration: "20 min",
    },
    {
      name: "Children & Seniors Haircut",
      description: "Quality cuts for kids and seniors",
      price: "$28",
      duration: "25 min",
    },
  ];
...
function Calendar({
  ...
  const isDisabled = (date: Date) => {
    // Disable if: in the past, on Sunday or Monday, or more than 2 weeks in advance
    return date < today || date.getDay() === 0 || date.getDay() === 1 || date > twoWeeksFromNow;
  };
        ...
        {currentStep === 2 && (
          <AnimatedSection>
            ...
            <div className="max-w-md mx-auto">
              ...
              <p className="text-center text-cream/40 text-sm mt-4">Closed Sundays &amp; Mondays. Bookings available up to 2 weeks in advance.</p>
            </div>
          </AnimatedSection>
        )}
  ...
  return (
    <section id="about" className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/images/haircut-1.jpg')`,
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          <AnimatedSection>
            <div className="relative mx-4 sm:mx-0">
              ...
              <div
                ...
                style={{
                  backgroundImage: `url('/images/barber-matt.jpg')`,
                }}
              />
          ...
          <AnimatedSection delay={200}>
            ...
            <h2 className="section-heading mb-6 sm:mb-8 text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
              A Cut
              <br />
              <span className="text-gradient">Above</span>
            </h2>
            <div className="space-y-4 sm:space-y-6 text-forest/70 font-sans leading-relaxed text-sm sm:text-base">
              <p>
                At King&apos;s Barber Shop, we combine traditional barbering techniques
                with modern styles. Located on Elm Street in the heart of Manchester,
                we&apos;ve built a space where you can relax, catch the game on our
                wide-screen TVs, and enjoy a drink while getting a quality cut.
              </p>
              <p>
                Our team of licensed barbers brings real skill and attention to
                every haircut, shave, and trim. Whether you want a classic look
                or something fresh, we make sure you leave looking and feeling great.
              </p>
              <p className="hidden sm:block">
                Stop by and experience what makes King&apos;s different. Great cuts,
                cold drinks, and good conversation, all on Elm Street.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 mt-8 sm:mt-12 pt-8 sm:pt-12 border-t border-forest/10">
              <div className="text-center sm:text-left">
                <p className="font-serif text-2xl sm:text-4xl text-forest mb-1 sm:mb-2">4</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <AnimatedSection>
            <div className="bg-cream-dark border border-cream/10 overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2910.5!2d-71.4548!3d42.9956!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89e24ed62f44b0f3%3A0x0!2s1650%20Elm%20Street%2C%20Manchester%2C%20NH%2003101!5e0!3m2!1sen!2sus!4v1"
                width="100%"
                height="300"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
              <div>
                <h3 className="font-serif text-lg sm:text-xl text-cream mb-1 sm:mb-2">KING&apos;S BARBER SHOP</h3>
              ...
              <div>
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=1650+Elm+Street+Manchester+NH+03101"
                  target="_blank"
            ...
            <div className="bg-cream-light border border-forest/10 p-4 sm:p-6 lg:p-8">
              ...
              <div className="mt-6 sm:mt-8 p-3 sm:p-4 bg-forest/10 border border-forest/20">
                <p className="text-forest/70 text-xs sm:text-sm">
                  <span className="text-forest font-semibold">Walk-ins welcome.</span> Call ahead to check wait times.
                </p>
              </div>
            </div>
          </AnimatedSection>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-cream/50 font-sans mb-4 sm:mb-6 text-sm sm:text-base">
              Traditional barbershop in Manchester, NH.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 sm:space-y-4 text-cream/50 text-sm sm:text-base">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <a href="tel:+16039322137" className="hover:text-cream transition-colors py-1 touch-manipulation">
                  (603) 932-2137
                </a>
              </div>
            </div>
        ...
        <div className="mt-10 sm:mt-16 pt-6 sm:pt-8 border-t border-cream/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-cream/30 text-xs sm:text-sm text-center sm:text-left">
            &copy; {new Date().getFullYear()} King&apos;s Barber Shop. All rights reserved.
          </p>
